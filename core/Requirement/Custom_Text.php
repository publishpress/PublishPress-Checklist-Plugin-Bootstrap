...
class Custom_Text extends Base_simple
{
    ...
    {
        $this->lang['label_settings'] = esc_html__('Say "PublishPress" in the content', 'publishpress-checklist-plugin-bootstrap');
        $this->lang['label']          = esc_html__('Say "PublishPress" in the content', 'publishpress-checklist-plugin-bootstrap');
    }

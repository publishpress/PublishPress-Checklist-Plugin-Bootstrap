...
if (!defined('PP_CHECKLIST_BOOTSTRAP_LOADED')) {
    ...
    /**
     * Call the composer's autoload. Avoid to use your own autoload.
     */
    ...
    define('PP_CHECKLIST_BOOTSTRAP_PLUGIN_FILE', 'publishpress-checklist-plugin-bootstrap/publishpress-checklist-plugin-bootstrap.php');
